...
<body style="background-image:url(meong.jpg); background-size:cover;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <center><h2>Data dokter</h2></center><br>
                        ...
                        if(mysqli_num_rows($result) > 0){
                            echo "<table class='table table-bordered table-striped '>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        echo "<td>" . $row['nama'] . "</td>";   
                                        echo '<td> <img  src= "source/' . $row['name'] . '" width="100" alt="auto"></td>';
